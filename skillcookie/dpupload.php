...
if(isset($_POST))
{
    ...
    if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
    {
        ...
        */
        ...
        echo '<tr>';
        echo '<td align="center"><img height=70 width=70 style="float:left;" src="uploads/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail">
                <span style="color:red;font-size:14px;float:right;"><br><br>Uploaded Successfully!</span>
        </td>';
        //echo '</tr><tr>';
        ...
        if(isset($_COOKIE['_u__'])) {
			...
			$dp_path = $thumb_DestRandImageName;
			if($ob->isDpSet($regno) == true) {
				//entry already exists
				mysql_query("UPDATE `profile` SET `dppath` = '".$dp_path."' WHERE `regno` = '".$regno."'");	
			} else {
				//mysql_query("INSERT INTO myImageTable (ImageName, ThumbName, ImgPath) 
        //VALUES ($DestRandImageName, $thumb_DestRandImageName, 'uploads/')");
				mysql_query("INSERT INTO `profile` (`regno`, `dppath`) VALUES ('".$regno."', '".$dp_path."')");
			}
		}
